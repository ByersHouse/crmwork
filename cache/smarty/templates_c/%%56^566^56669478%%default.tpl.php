<?php /* Smarty version 2.6.29, created on 2017-10-12 12:55:29
...
<?php else: ?>info<?php endif; ?>">Alert</strong>
        ...
        <p class="alert-body">
            <h3><?php echo ((is_array($_tmp=$this->_tpl_vars['result']->description)) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
</h3>
            <hr>
            <?php echo ((is_array($_tmp=$this->_tpl_vars['result']->name)) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
<br/>
            <?php if ($this->_tpl_vars['result']->message_to_assigned != null): ?>
            <hr>
            <b>Сообщение:</b><br/>
            <?php echo ((is_array($_tmp=$this->_tpl_vars['result']->message_to_assigned)) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
