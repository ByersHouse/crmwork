...
', '<?php echo $this->_tpl_vars['savedSearchData']['module']; ?>
...
">
    <li class="sugar_action_button desktopOnly">
        <a href="javascript:void(0)" class="glyphicon glyphicon-list-alt clearSearchIcon parent-dropdown-handler" onclick="SUGAR.savedViews.shortcutDropdown('_none', '<?php echo $this->_tpl_vars['savedSearchData']['module']; ?>
');"></a>
        <a href="javascript:void(0)" class="glyphicon glyphicon-remove" onclick="SUGAR.savedViews.shortcutDropdown('_none', '<?php echo $this->_tpl_vars['savedSearchData']['module']; ?>
');">&Cross;</a>
    </li>
