...
',
  ...
  'LBL_CREATED_BY_NAME' => 'Кем создано',
...
<tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
  ...
  'LBL_CONFIRM_DELETE' => 'Вы действительно хотите удалить эту папку?',
  ...
  'LBL_CREATE_CASES' => 'Создание Обращений',
  'LBL_CREATE_LEADS' => 'Создание Предварит. контактов',
  'LBL_CREATE_CONTACTS' => 'Создание Контактов',
  'LBL_CREATE_BUGS' => 'Новые Ошибки',
  'LBL_CREATE_TASKS' => 'Создание Задач',
  'LBL_CHECK_INLINE' => 'Верно',
  'LBL_CLOSE' => 'Закрытие',
  'LBL_HELP' => 'Справка',
  'LBL_GMAIL_LOGO' => 'Gmail',
  'LBL_YAHOO_MAIL' => 'Yahoo',
  'LBL_EXCHANGE_LOGO' => 'MS Exchange',
  'LBL_WAIT' => 'Подождите',
  'LBL_CHECKEMAIL' => 'Проверить почту',
  'LBL_COMPOSEEMAIL' => 'Создать E-mail',
  ...
  'LBL_EXT_PASSWORD' => 'Пароль оператора',
  'LBL_WS_SERVER' => 'Сокет сервер',
);