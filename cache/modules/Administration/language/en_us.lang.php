...
4) Click Schedule System Index. Make sure that crontab is set up to run cron.php. This will handle indexing as well as the fallback mechanism when the connection to the search engine is interrupted.',
  ...
  'LBL_MANAGE_ASTERISK' => 'Module Configuration',
  'LBL_ASTERISK' => 'Set the Asterisk connection parameters and other preferences',
  'LBL_ASTERISK_DESC' => 'Set the Asterisk connection parameters and other preferences',
  'LBL_ASTERISK_TITLE' => 'Callinize - Asterisk SugarCRM Integration',
  'LBL_ASTERISK_DONATE' => 'Upgrade',
  'LBL_ASTERISK_DONATE_DESC' => 'Learn more about the advanced features included in Callinize Pro',
  'LBL_ASTERISK_USERMANUAL' => 'User Manual',
  'LBL_ASTERISK_USERMANUAL_DESC' => 'Links to the online documentation for this project',
  'LBL_ASTERISK_MAILINGLIST' => 'Mailing List',
  'LBL_ASTERISK_MAILINGLIST_DESC' => 'Sign up and be informed of updates to this module',
  'LBL_ASTERISK_FAKECALL' => 'Fake Call',
  'LBL_ASTERISK_FAKECALL_DESC' => 'Test utility to create calls for testing call popups without needing to make a real call.',
);