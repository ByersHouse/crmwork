...
Последняя попытка подключения @ ',
  ...
  'LBL_RESET_CACHE' => 'Очистите кэш.',
  'LBL_RESET_CACHE_DESC' => 'Полностью очистить кэш, включая локальные и внешние хранилища с опкодами',
...
',
  ...
  'LBL_FTS_HOST' => 'Хост',
  'LBL_FTS_PORT' => 'Порт',
  'LBL_FTS_TYPE_HELP' => 'Выберите средство полнотекстового поиска. Система обнаруживает доступные средства и отображает их в списке. SuiteCRM включает в себя встроенную поддержку elasticsearch.',
  'LBL_FTS_HOST_HELP' => 'Введите имя узла, где установлено средство полнотекстового поиска.',
  'LBL_FTS_PORT_HELP' => 'Введите имя порта, где установлено средство полнотекстового поиска.',
  ...
  'LBL_SAVE_SCHED_WARNING' => 'Вы уверены, что хотели бы выполнить индексацию в настоящее время? Во время индексации производительность системы может снизиться.',
  'LBL_FTS_NO_MODULES' => 'Выберите по крайней мере один модуль для поиска.',
  'LBL_FTS_NO_MODULES_FOR_SCHED' => 'Выберите по крайней мере один модуль для настройки планировщика.',
  ...
  'LBL_FTS_CONN_SUCCESS' => 'Подключение выполнено. Вам необходимо будет выполнить индексацию для возможности полнотекстового поиска внутри включенных модулей и их полей данных.',
  'LBL_FTS_CONN_SUCCESS_SHORT' => 'Запуск индексации запланирован в ближайшие несколько минут.',
  'LBL_FTS_CONN_FAILURE_SHORT' => 'Не удалось настроить задание индексации в планировщике.',
  'LBL_FTS_PAGE_DESC' => 'Чтобы включить полнотекстовый поиск:<br>
1) Выберите средство поиска, которое будет использоваться<br>
2) Укажите узел и порт сервера средства поиска<br>
3) Нажмите кнопку "Тест", чтобы убедиться, что SuiteCRM удается подключиться к средству поиска<br>
4) Нажмите кнопку "Расписание". Убедитесь, что crontab настроен на запуск cron.php. Этот механизм будет управлять индексацией при отсутствии связи со средством поиска.',
  'LBL_FTS_DISABLED' => 'Полнотекстовый поиск был отключен, поскольку система не может подключиться к средству поиска.',
  'LBL_FTS_CONNECTION_INVALID' => 'Заданные вами параметры полнотекстового поиска не верны и могут замедлить работу системы. Пожалуйста измените настройки или установите их в значения по-умолчанию.',
  ...
  'LBL_AOP_MEETING_RESPONSE_URL' => 'URL для входа в конференцию',
  ...
  'MSG_CACHE_CLEANED' => 'Кэш пуст.',
  'MSG_NOT_CACHE_CLEANED' => 'Кэш не может быть очищен',
  'LBL_USER_LOCKOUT' => 'Блокировка пользователя',
  'LBL_MAX_FAILED_LOGINS' => 'Максимальное количество неудачных попыток входа',
  'LBL_MAX_FAILED_LOGINS_HELP' => 'Количество неудачных попыток входа до того, как учетная запись пользователя будет заблокирована.',
  'LBL_AUTO_UNLOCK_TIME' => 'Время автоматической разблокировки учетной записи пользователя',
  'LBL_AUTO_UNLOCK_TIME_HELP' => 'Число минут, через которое, учётная запись пользователя будет автоматически разблокирована.',
  'LBL_AUTO_UNLOCK_TIME_UNITS' => 'минут',
  'ERR_MAX_FAILED_LOGINS' => 'Пожалуйста, укажите правильное значение для максимального числа неудачных попыток входа',
  'ERR_AUTOMATIC_UNLOCK_TIME' => 'Пожалуйста, укажите правильное значение времени, через которое произойдёт автоматическая разблокировка',
  'LBL_ENABLE_MAX_FAILED_LOGINS' => 'Число неудачных попыток входа до блокировки пользователя',
  'LBL_AUTO_UNLOCK' => 'Автоматически разблокировать блокированных пользователей',
  'LBL_AUTO_UNLOCK_HELP' => 'Разблокировать блокированных пользователей через настраиваемый промежуток времени',
);