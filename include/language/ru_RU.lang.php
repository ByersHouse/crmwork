...
//e.g. auf Deutsch 'Contacts'=>'Contakten',
    ...
    'moduleList' => array(
        ...
        'Prospects' => 'Адресаты',
        'Queues' => 'Очереди',
        'EmailMarketing' => 'Маркетинг через E-mail',
...
$app_strings = array(
    'LBL_TEST_SETTINGS'     => 'Тест настроек', //PR 3333
    'LBL_TOUR_NEXT' => 'Далее',
    ...
    'LBL_NO_ACTION' => 'С этим ничего не поделать: %s',
    ...
    'LBL_EMAIL_ERROR_SAVING' => 'Ошибка при сохранении электронной почты. Обратитесь к администратору за помощью.',
    ...
    'LBL_EMAIL_DRAFT_CONFIRM_DISCARD' => 'Пожалуйста, подтвердите удаление черновика нажатием OK.',
    ...
    'LBL_DEFAULT_EMAIL_SIGNATURES' => 'Шаблон подписи письма',
    ...
    'LBL_PORTAL_WELCOME_INFO' => 'Портал SuiteCRM представляет собой основу, которая обеспечивает в реальном времени представление случаев, ошибок и информационные бюллетени и т. д. для клиентов. Это внешний интерфейс для SuiteCRM, которая может быть развернута в рамках любого веб-сайта.',
    'LBL_LIST' => 'Список',
...
5. Из меню модуля запустите процесс импорта и выберите только что сохранённый файл в качестве источника данных для загрузки
   ...
   ',
    ...
    'LBL_CONFIRM_DISREGARD_DRAFT_TITLE' => 'Удалить черновик', // PR 4042
    'LBL_CONFIRM_DISREGARD_DRAFT_BODY' => 'Эта операция удалит это письмо, вы действительно этого хотите?', // PR 4042
    'LBL_CONFIRM_APPLY_EMAIL_TEMPLATE_TITLE' => 'Применение шаблона', // PR 4042
    'LBL_CONFIRM_APPLY_EMAIL_TEMPLATE_BODY' => 'Тема и содержимое письма будут заменены данными из шаблона. Продолжить?', // PR 4042
);
...
$app_strings['LBL_PRINT_AS_PDF'] = 'Печать в PDF-формате';
...
$app_strings['LBL_GANTT_BUTTON_TITLE'] = 'Представление диаграммы Ганта';
$app_strings['LBL_DETAIL_BUTTON_LABEL'] = 'Показать подробности';
$app_strings['LBL_DETAIL_BUTTON_TITLE'] = 'Показать подробности';
