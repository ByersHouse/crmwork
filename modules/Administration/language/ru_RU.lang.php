...
Последняя попытка подключения @ ',
    ...
    'LBL_LDAP_ADMIN_USER_DESC' => 'Используется для поиска пользователя LDAP. Может потребоваться указать в fully qualified формате.', // PR 3745
    'LBL_LDAP_ADMIN_PASSWORD' => 'Пароль:',
    'LBL_LDAP_AUTHENTICATION' => 'Аутентификация:',
    'LBL_LDAP_AUTHENTICATION_DESC' => 'Связь с LDAP сервером с использованием учётной записи конкретного пользователя. Если данные отсутствуют, связь будет установлена анонимно.', // PR 3745
    ...
    'LBL_LDAP_USER_FILTER_DESC' => 'Любые дополнительные параметры, применяемые в процессе аутентификации пользователей, например: <em>is_suitecrm_user=1 или (is_suitecrm_user=1)(is_sales=1)</em>', // PR 3745
    'LBL_LDAP_LOGIN_ATTRIBUTE' => 'Login-атрибут:',
    'LBL_LDAP_BIND_ATTRIBUTE' => 'Bind-атрибут:',
    'LBL_LDAP_BIND_ATTRIBUTE_DESC' => 'Пользователь для&nbsp;соединения с&nbsp;LDAP<br>Пример:<b>AD:</b>&nbsp;userPrincipalName,&nbsp;<b>openLDAP:</b>&nbsp;dn,&nbsp;<b>Mac&nbsp;OS&nbsp;X:</b>&nbsp;uid ', // PR 3745
    'LBL_LDAP_LOGIN_ATTRIBUTE_DESC' => 'Пользователь для&nbsp;соединения с&nbsp;LDAP<br>Пример:<b>AD:</b>&nbsp;userPrincipalName,&nbsp;<b>openLDAP:</b>&nbsp;dn,&nbsp;<b>Mac&nbsp;OS&nbsp;X:</b>&nbsp;uid ', // PR 3745
