...
$mod_strings = array(
    ...
    'LOCK_HOMEPAGE_HELP' => 'Данный параметр запрещает:<BR> 1) добавлять дашлеты на главную страницу системы <BR>2) перемещать дашлеты на главной странице системы.',
...
// Wizard
    ...
    'LBL_WIZARD_FINISH' => 'Кликните <b>Продолжить</b> для настройки ваших пераметров.<br/><br/>Чтобы настроить дополнительные системные параметры, кликните <a href="index.php?module=Administration&action=index" target="_blank">здесь</a>.',
    ...
    'LBL_GMAIL_LOGO' => 'Лого Gmail' /*for 508 compliance fix*/,
    'LBL_YAHOO_MAIL' => 'Yahoo! Mail' /*for 508 compliance fix*/,
    'LBL_EXCHANGE_LOGO' => 'MS Exchange' /*for 508 compliance fix*/,
