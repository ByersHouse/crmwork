...
$mod_strings = array (
    ...
    'LBL_MIME_TYPE_ERROR_2' => 'Для импортирования выбранного файла нажмите на кнопку ОК. Чтобы загрузить новый файл Попробовать ещё раз.',
    ...
    'LBL_EXTERNAL_ERROR_FEED_CORRUPTED' => 'Невозможно получить внешние данные, пожалуйста, повторите попытку позже.',
    ...
    'LBL_EXTERNAL_ASSIGNED_TOOLTIP' => 'Чтобы назначить новые записи не себе, а другому пользователю, выберите его в колонке "Значение по умолчанию".',
    'LBL_EXTERNAL_TEAM_TOOLTIP' => 'Чтобы назначить новые записи не своей, а другой группе(ам), выберите другие группы в колонке "Значение по умолчанию".',
