...
class Lead extends Person {
    ...
    var $primary_address_street_3;
        ...
        var $zagrpas_datavidachy;
        var $zagrpas_date_end;
        ...
        var $volume_trans1;
        var $volume_trans2;
        var $transport_owner3;
        var $transport_owner4;
        var $how_buytransport3;
        var $how_buytransport4;
        var $yearissuetrans3;
        var $yearissuetrans4;
        var $trans3_manufacturer;
        var $trans4_manufacturer;
        var $model_trans3;
        var $model_trans4;
        var $volume_trans3;
        var $volume_trans4;
